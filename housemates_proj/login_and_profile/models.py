...
class HouseNotifications(models.Model):
    ACTIONS = (
        ('PURCHASED', 'purchased'),
        ('INVITED', 'invited'),
        ('CREATED', 'created'),
    ...
    sender = models.ForeignKey(
        User, on_delete=CASCADE, blank=True, null=True, related_name='sender_notification')
    receiver = models.ForeignKey(User, on_delete=CASCADE,
                                 blank=True, null=True, related_name='receiver_notification')
    house = models.ForeignKey(
        House, on_delete=CASCADE, related_name='notifications')
...
class HouseMembership(models.Model):
    ...
    house = models.ForeignKey(
        House, related_name="membership", on_delete=CASCADE,)
    user = models.ManyToManyField(
        User, related_name="users_house")
